---
title: "プロフィール"
description: "GesonAnko (Yasuhiro SHIMOMURA / 下村晏弘) のプロフィール"
...
好奇心ベースの自律機械知能 "P-AMI\<Q>" (以前は Primitive Autonomous Machine Intelligence based on Q(Cu)riosity の略称でした。)は私の第 2 子となる AMI です。[**VRChat**](https://hello.vrchat.com)というソーシャル VR 空間に実装し、その行動や学習過程を観察・分析しています。彼らはとても興味深い存在であり、訳のわからないことばかりおきますが、それを探求するのがたまらなく楽しいのです。

P-AMI\<Q>の研究・開発には ML 集会や様々な場所で出会った多くの方々にご協力をいただいております。誠にありがとうございます。

その研究成果は[**バーチャル学会**](https://vconf.org/portal/)にて発表しております：

- RSJ2025: [**PAMIQ Core: リアルタイム継続学習のための非同期推論・学習フレームワーク**](/pdfs/pamiq-core-paper.rsj2025.pdf)
...
_2024/03:_ [**仙台高等専門学校 校長賞 (学業成績優秀賞)**](/pdfs/PrincipalAward.pdf)

_2023/05:_ [**集中講座 世界モデルと知能 2022 最終課題発表会 ポスター発表 最優秀賞**](/pdfs/MatsuoPoster.pdf)

## 研究成果

- _2025/09:_ [**PAMIQ Core: リアルタイム継続学習のための非同期推論・学習フレームワーク**](/pdfs/pamiq-core-paper.rsj2025.pdf)
...
- _2023/05:_ [**AutoOshaberi - Audio2Speech - 「発声器官モデルと Dreamer を用いた任意音響の模倣音声生成手法」**](/pdfs/AutoOshaberi.pdf)
...
- **2025/12:** [バーチャル学会 2025 エクスカーション企画](https://www.vconf.org/2025/events/excursion/)
...
- **開発**
  ...
  - [GitHub (個人)](https://github.com/Geson-anko)
  - [GitHub (チーム、研究開発)](https://github.com/MLShukai)
  - [Booth (個人)](https://gesonanko.booth.pm)

- **ブログ・技術発信**

  - [Qiita](https://qiita.com/GesonAnko)
  - [Zenn](https://zenn.dev/gesonanko)
  - [note](https://note.com/gesonanko) (VRChat 関連)
  - [Speaker Deck](https://speakerdeck.com/gesonanko#) (スライド)

- **ソーシャルメディア**

  - [X (Twitter)](https://x.com/GesonAnkoVR) (研究や開発の日々の進捗、雑談など)

- **コミュニティ**
  - [ML 集会](https://discord.gg/bDW3Xhj6f7) (機械学習コミュニティ＆チーム開発)
