...
<img src="https://{{ site.github.repository_name }}/assets/images/thumbnail.png" width="100%">
...
- **ソーシャルメディア**
  ...
  - [<i class="fab fa-twitter"></i> X (Twitter)](https://x.com/GesonAnkoVR) (研究や開発の日々の進捗、雑談など)

- **コミュニティ**
  - [<i class="fab fa-discord"></i> ML 集会](https://discord.gg/bDW3Xhj6f7) (機械学習コミュニティ＆チーム開発)
...
- VRChat・ML 集会・コミュニティ関連: [<i class="fab fa-discord"></i> Discord](https://discord.gg/bDW3Xhj6f7)
